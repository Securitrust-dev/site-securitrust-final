...
import { Shield, CheckCircle, Server, Lock, AlertTriangle, ArrowRight, Box, Cpu } from 'lucide-react';

export default function AuditSecuriteTechniquePage() {
  return (
    <div className="relative min-h-screen antialiased text-slate-300 selection:bg-cyan-500 selection:text-black" style={{ background: '#030303' }}>
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-slate-400 font-light tracking-wide border-l-2 border-cyan-500 pl-6 text-left mb-6">
                L&apos;<strong>audit de sécurité technique</strong> constitue une <strong>évaluation globale</strong> de votre infrastructure IT, combinant l&apos;analyse des configurations, de l&apos;architecture, des vulnérabilités système et des procédures de sécurité en place.
              </p>
              <p className="text-lg md:text-xl text-slate-400 font-light tracking-wide border-l-2 border-cyan-500 pl-6 text-left">
                Cette approche <strong>holistique</strong> permet d&apos;obtenir une vision complète de votre <strong>posture de sécurité</strong> et d&apos;identifier les points critiques nécessitant une attention immédiate.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden border-cyan-500/30 shadow-[0_0_15px_rgba(118,166,209,0.1)]">
                  ...
                  <h4 className="text-xl font-medium text-white mb-4">Infrastructure système</h4>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Analyse des serveurs, postes de travail, systèmes d&apos;exploitation et configurations
                  </p>
                </div>
              </div>
              ...
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden">
                  ...
                  <h4 className="text-xl font-medium text-white mb-4">Équipements de sécurité</h4>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Revue des pare-feu, IDS/IPS, antivirus, et solutions de protection
                  </p>
                </div>
              </div>
              ...
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden">
                  ...
                  <h4 className="text-xl font-medium text-white mb-4">Gestion des accès</h4>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Évaluation des mécanismes d&apos;authentification, autorisation et traçabilité
                  </p>
                </div>
              </div>
              ...
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden">
                  ...
                  <h4 className="text-xl font-medium text-white mb-4">Scan de vulnérabilités</h4>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Détection automatisée des failles connues et configuration à risque
                  </p>
                </div>
              </div>
              ...
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden">
                  ...
                  <h4 className="text-xl font-medium text-white mb-4">Procédures & conformité</h4>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Vérification des politiques, procédures et conformité aux standards
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="glass-panel p-8 rounded-xl border border-white/5">
                ...
                <ul className="space-y-4 text-slate-300">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Phase de reconnaissance et collecte d&apos;informations</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Tests techniques automatisés et manuels</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Analyse des résultats et corrélation</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Évaluation de la criticité des découvertes</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="glass-panel p-8 rounded-xl border border-white/5">
                ...
                <ul className="space-y-4 text-slate-300">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Synthèse exécutive pour la direction</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Rapport technique détaillé avec preuves</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Présentation orale des résultats</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="glass-panel p-12 rounded-2xl border-2 border-cyan-500/20 relative overflow-hidden">
              ...
              <h2 className="text-4xl md:text-5xl font-semibold text-white mb-6 tracking-tight relative z-10">
                Évaluez votre sécurité technique
              </h2>
              <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto relative z-10">
                Obtenez une vision complète de votre posture de sécurité avec notre audit technique approfondi.
              </p>
        ...
        <InternalLinks pageKey="audit-securite-technique" />
        <Footer />
      </div>
    </div>
  );
