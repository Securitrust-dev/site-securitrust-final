...
const PLANS: Record<string, {
  ...
  essentiel: {
    ...
    priceMonthly: 1950,
    priceAnnual: 23400,
    target: "Assurez-vous d'avoir les basics de la cyber",
    popular: false,
    features: [
      "Amélioration scoring assureur (jusqu'à -10%)",
      'Identification de risque (Basique)',
      'Pilotage ISO 27001 (Basique)',
      'Reporting RGPD & NIS2 (Partiel)',
      'Scan vulnérabilités mensuel',
      'Monitoring SSL & ports 24/7 (Basique)',
      'KPI & dashboards mensuels',
      'Rapport PDF mensuel',
      'Alertes hebdomadaires',
      'Déploiement 48h après validation du plan',
    ],
  },
  premium: {
    name: 'Premium',
    priceMonthly: 4500,
    priceAnnual: 54000,
    target: 'SI structuré avec forts enjeux de sécurité',
    popular: true,
    features: [
      "Amélioration scoring assureur (jusqu'à -20%)",
      'Identification de risque Ebios RM light',
      'ISO 27001 automatisé & reporting complet',
      'Reporting RGPD & NIS2 complet',
      'KPI par service auto',
      'Exercice de crise 1x / an',
  ...
  enterprise: {
    ...
    priceAnnual: 102000,
    pricePrefix: 'Dès',
    target: 'Enjeux réglementaires forts, SI Mature',
    popular: false,
    features: [
      "Amélioration scoring assureur (jusqu'à -30%)",
      'Identification de risque Ebios RM complet',
      'ISO 27001 avancé multi-entités',
      'Reporting sur-mesure (Board / Comité)',
      'KPI Board / Comité',
      'Exercice de crise 2x / an',
      'Scan vulnérabilités hebdomadaire',
      'Scan Cloud approfondi',
      'Dark Web & OSINT quotidiens',
      'Alertes en temps réel',
      'Cellule de crise dédiée + SLA garanti',
              ...
              <div className={`rounded-2xl border p-7 bg-white/[0.03] ${p.popular ? 'border-cyan-500/50' : 'border-white/10'}`}>
                ...
                <div className="border-t border-white/10 pt-5 mb-5">
                  <div className="flex items-baseline gap-1">
                    {p.pricePrefix && (
                      <span className="text-slate-400 text-sm mr-1">{p.pricePrefix}</span>
                    )}
