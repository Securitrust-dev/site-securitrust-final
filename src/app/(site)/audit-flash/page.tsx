        ...
        <section className="py-16 px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { title: 'Pentest au Résultat', href: '/pentest-au-resultat', desc: 'Après l\'audit flash, allez plus loin : test d\'intrusion complet remboursé si aucune faille trouvée.' },
                { title: 'Pentest Externe', href: '/pentest-externe', desc: 'Tests d\'intrusion approfondis sur vos assets exposés après identification des vulnérabilités en audit flash.' },
                { title: 'Audit Cybersécurité', href: '/audit-cybersecurite', desc: 'Audit complet et méthodique de votre posture de sécurité pour un bilan exhaustif.' },
              ].map((s, i) => (
