...
export default function PropositionPage() {
  ...
  return (
    <div className="antialiased selection:bg-[#00ffa3] selection:text-[#030303] overflow-x-hidden text-[#e0e0e0] font-['Inter',sans-serif] bg-[#030303] min-h-screen bg-tech-grid">
      ...
      <nav className="fixed w-full z-50 top-0 border-b border-white/10 bg-[#030303]/90 backdrop-blur-xl">
        <div className="flex h-16 max-w-[1920px] mx-auto px-6 md:px-12 items-center justify-between">
          ...
          <div className="hidden lg:flex items-center border-x border-white/10 h-full px-8">
            <div className="uppercase text-[#888888] text-xs font-semibold tracking-wide px-6">
      ...
      {/* PARTNERS (Grid Style from Aetheris) */}
      <section className="border-b border-white/10 bg-[#030303]" aria-label="Trusted Partners">
        <div className="max-w-[1920px] mx-auto grid grid-cols-2 md:grid-cols-6 divide-x divide-y md:divide-y-0 divide-white/10">
          <div className="p-6 md:p-10 flex items-center justify-center grayscale hover:grayscale-0 transition-all opacity-50 hover:opacity-100">
            <span className="font-['Inter',sans-serif] font-semibold text-lg md:text-xl tracking-tight text-white">SOCIÉTÉ GÉNÉRALE</span>
          </div>
          <div className="p-6 md:p-10 flex items-center justify-center grayscale hover:grayscale-0 transition-all opacity-50 hover:opacity-100">
            <span className="font-['Inter',sans-serif] font-semibold text-lg md:text-xl tracking-tight text-white">AVIVA</span>
          </div>
          <div className="p-6 md:p-10 flex items-center justify-center grayscale hover:grayscale-0 transition-all opacity-50 hover:opacity-100">
            <span className="font-['Inter',sans-serif] font-semibold text-lg md:text-xl tracking-tight text-white">VEOLIA</span>
          </div>
          <div className="p-6 md:p-10 flex items-center justify-center grayscale hover:grayscale-0 transition-all opacity-50 hover:opacity-100">
            <span className="font-['Inter',sans-serif] font-semibold text-lg md:text-xl tracking-tight text-white">ABEILLE</span>
          </div>
          <div className="p-6 md:p-10 flex items-center justify-center grayscale hover:grayscale-0 transition-all opacity-50 hover:opacity-100">
            <span className="font-['Inter',sans-serif] font-semibold text-lg md:text-xl tracking-tight text-white">BANQUE POPULAIRE</span>
          </div>
          <div className="p-6 md:p-10 flex items-center justify-center grayscale hover:grayscale-0 transition-all opacity-50 hover:opacity-100">
            <span className="font-['Inter',sans-serif] font-semibold text-lg md:text-xl tracking-tight text-white">AFFLUENS</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12 flex items-end justify-between reveal">
            <div>
              ...
              <p className="text-[#888888] text-sm md:text-base max-w-md">Un arsenal complet de documents pour piloter votre remédiation.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-white/10">
            <article className="group border-b md:border-b-0 md:border-r border-white/10 p-6 md:p-8 hover:bg-white/[0.03] hover:border-[#00ffa3] transition-all duration-300 bg-[#080808] reveal">
              ...
              <p className="text-sm md:text-base text-[#888888] leading-relaxed mb-4">Une analyse exhaustive de chaque vulnérabilité avec preuve de concept (PoC).</p>
            </article>
            <article className="group border-b md:border-b-0 md:border-r border-white/10 p-6 md:p-8 hover:bg-white/[0.03] hover:border-[#00ffa3] transition-all duration-300 bg-[#080808] reveal">
              <div className="w-10 h-10 bg-[#030303] border border-white/10 flex items-center justify-center mb-6 text-[#00ffa3]">
              ...
              <p className="text-sm md:text-base text-[#888888] leading-relaxed mb-4">Priorisation des actions selon l'impact business et la complexité technique.</p>
            </article>
            <article className="group border-b md:border-b-0 border-white/10 p-6 md:p-8 hover:bg-white/[0.03] hover:border-[#00ffa3] transition-all duration-300 bg-[#080808] reveal">
              <div className="w-10 h-10 bg-[#030303] border border-white/10 flex items-center justify-center mb-6 text-[#00ffa3]">
                <Zap className="w-5 h-5" />
              </div>
              <h3 className="font-['Inter',sans-serif] text-xl font-semibold mb-3 tracking-tight text-white uppercase">Support 30j</h3>
              <p className="text-sm md:text-base text-[#888888] leading-relaxed mb-4">Accompagnement de vos équipes IT pour la mise en œuvre des correctifs.</p>
            </article>
          </div>
        </div>
      </section>
      ...
      <section id="investment" className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="bg-[#080808] p-8 md:p-24 border-b md:border-b-0 md:border-r border-white/10 flex flex-col justify-center items-center relative overflow-hidden reveal">
          <div className="relative w-56 h-56 md:w-64 md:h-64">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-xs text-[#888888] uppercase tracking-wider">Investissement HT</span>
            </div>
          </div>
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 text-center w-full max-w-sm">
            <div>
              ...
              <div className="text-[10px] text-[#888888] uppercase tracking-widest">Délai de livraison</div>
            </div>
            <div>
              ...
              <div className="text-[10px] text-[#888888] uppercase tracking-widest">Garantie résultat</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#030303] p-8 md:p-24 flex flex-col justify-center reveal">
          ...
          <div className="space-y-6 mb-10">
            {[
              { id: 1, title: 'Audit Active Directory', desc: 'Audit complet de l\'architecture et des configurations de sécurité.' },
              { id: 2, title: 'Tests d\'intrusion', desc: 'Simulation d\'attaques réelles depuis un poste utilisateur compromis.' },
              { id: 3, title: 'Revue des Privilèges', desc: 'Analyse critique des groupes d\'administration et des accès sensibles.' }
            ].map((item) => (
              <div key={item.id} className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-[#00ffa3] font-semibold font-mono shrink-0 border border-white/10">{item.id}</div>
                <div>
                  <h4 className="font-semibold text-white text-lg uppercase">{item.title}</h4>
            ...
            <div className="md:w-2/3 space-y-0 relative border-l border-white/10 ml-2 md:ml-0">
              <div className="relative pl-8 md:pl-10 pb-12 reveal group">
                ...
                <div className="border border-white/10 bg-[#080808]/50 p-6 hover:bg-[#080808] transition-colors">
                  <h3 className="font-semibold text-lg text-white mb-2 uppercase">Genesis (Jour 1)</h3>
                  <p className="text-xs text-[#888888]">Collecte des informations et définition précise du périmètre d'audit.</p>
                </div>
              </div>
              <div className="relative pl-8 md:pl-10 pb-12 reveal group">
              ...
              <div className="relative pl-8 md:pl-10 reveal group">
                ...
                <div className="border border-white/10 border-dashed bg-transparent p-6 opacity-60 hover:opacity-100 transition-opacity">
                  ...
                  <p className="text-xs text-[#888888]">Restitution finale et transfert de compétences complet.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="relative z-20 p-6 md:p-8 flex flex-col justify-between h-full">
                <div className="flex justify-between items-start">
                  <div className="bg-[#030303]/80 backdrop-blur-md p-4 border border-white/10">
                    <h2 className="font-['Inter',sans-serif] text-xl md:text-2xl font-semibold mb-1 text-white tracking-tight uppercase">Live Topology</h2>
                    <p className="text-[#888888] text-[10px] font-mono tracking-widest uppercase">STATUS: MONITORING</p>
                  </div>
                  <div className="flex gap-2">
                    <div className="w-2 h-2 bg-[#00ffa3] rounded-full animate-pulse"></div>
                    <div className="font-mono text-[10px] text-[#00ffa3] hidden md:block uppercase tracking-widest">UPLINK ACTIVE</div>
                  </div>
                </div>
              ...
              <div className="bg-[#030303] border border-white/10 p-6 reveal h-full flex flex-col justify-center">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-[#080808] border border-white/10">
                    <span className="text-xs text-[#888888] uppercase">Nodes Active</span>
                  ...
                  <div className="flex justify-between items-center p-3 bg-[#080808] border border-white/10">
                    ...
                    <span className="font-mono text-[#00ffa3] font-semibold">12ms</span>
                  </div>
                </div>
                <div className="mt-8">
      ...
      <section className="py-24 md:py-32 bg-[#080808] relative overflow-hidden flex flex-col items-center justify-center h-[70vh] md:h-[90vh]">
        ...
        <div className="relative z-10 text-center reveal pointer-events-none px-6">
          <span className="text-[#00ffa3] font-mono text-[10px] tracking-[0.5em] uppercase bg-black/50 backdrop-blur-md px-4 py-1 rounded-full border border-[#00ffa3]/20">The Singularity</span>
          ...
          <p className="text-[#888888] text-sm md:text-base max-w-md mx-auto mt-6 bg-black/30 backdrop-blur-sm p-4 rounded-lg border border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 mb-16 items-center">
            <div className="md:w-1/2 reveal">
              <div className="inline-block px-3 py-1 border border-white/10 bg-white/5 rounded-full mb-6">
                <span className="text-[10px] font-mono text-[#00ffa3] uppercase tracking-widest">Notre Mandat</span>
              </div>
              <h2 className="font-['Inter',sans-serif] text-3xl md:text-4xl font-semibold mb-4 tracking-tight text-white uppercase">Prophétie & Purpose</h2>
              <p className="text-[#888888] text-sm md:text-base leading-relaxed mb-6">
                SecuriTrust est née d'une vision de souveraineté numérique absolue. Nous croyons en un futur où la confiance est cryptographiquement garantie et où chaque entreprise peut opérer en toute sérénité.
              </p>
            </div>
            <div className="md:w-1/2 reveal">
              <Image 
                ...
                width={800}
                height={600}
                className="w-full h-auto object-cover rounded-xl border border-white/10 grayscale hover:grayscale-0 transition-all duration-500"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border border-white/10 p-6 md:p-8 bg-[#080808] reveal">
            <div className="space-y-6 text-[#888888] text-sm md:text-base leading-relaxed border-b md:border-b-0 md:border-r border-white/10 pb-8 md:pb-0 md:pr-8">
              <p>
                L'infrastructure actuelle nécessite une refonte profonde vers plus de décentralisation et de transparence. Nous sommes les architectes de cette nouvelle ère de liberté numérique.
              </p>
              <ul className="space-y-2 pl-4 border-l border-[#00ffa3]/30">
                <li className="flex items-start gap-2 text-white font-medium"><span className="text-[#00ffa3] text-lg leading-none">•</span> Fondation Décentralisée</li>
                <li className="flex items-start gap-2 text-white font-medium"><span className="text-[#00ffa3] text-lg leading-none">•</span> Accès Inclusif</li>
                <li className="flex items-start gap-2 text-white font-medium"><span className="text-[#00ffa3] text-lg leading-none">•</span> Catalyseur d'Innovation</li>
              </ul>
            </div>
            <div className="space-y-6 text-[#888888] text-sm md:text-base leading-relaxed md:pl-8">
              ...
              />
              <p>
                Chaque ligne de code est pensée pour garantir une résilience maximale. Nous façonnons le système d'exploitation d'un monde plus équitable.
              </p>
              <a href="#" className="text-[#00ffa3] text-sm font-semibold uppercase tracking-widest flex items-center gap-2 hover:underline">
                Explorer notre manifeste <ArrowRight className="w-4 h-4" />
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="overflow-hidden group py-24 md:py-32 relative">
        ...
        <div className="max-w-4xl mx-auto text-center px-6 relative z-10 reveal">
          <h2 className="font-['Inter',sans-serif] text-4xl md:text-7xl font-bold uppercase tracking-tighter mb-8 text-white">
            Rejoignez la <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#00ffa3]">Révolution</span>
          </h2>
          <p className="font-mono text-sm md:text-base text-[#888888] mb-10 max-w-lg mx-auto">
            &gt; La sécurité est un bien commun.<br/>
            &gt; Soyez acteur de votre défense.<br/>
            &gt; Reprenez votre souveraineté.
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <button className="bg-[#00ffa3] text-[#030303] px-10 py-4 font-semibold uppercase hover:shadow-[0_0_20px_rgba(0,255,163,0.5)] transition-shadow">
              Démarrer le projet
            </button>
        ...
        <div className="max-w-[1920px] mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-20">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-[#888888] text-xs leading-relaxed max-w-xs mt-4">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-xs text-[#888888] uppercase tracking-widest">
                <li><a href="#" className="hover:text-[#00ffa3] transition-colors">Blog</a></li>
                <li><a href="#" className="hover:text-[#00ffa3] transition-colors">Portfolio</a></li>
              </ul>
            </div>
            <div>
              <h5 className="text-white font-medium text-sm mb-4">Contact</h5>
              <ul className="space-y-2.5 text-xs text-[#888888] font-mono uppercase tracking-widest">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-8 h-8 flex items-center justify-center text-[#888888] hover:text-white transition-colors border border-white/10 hover:border-white/30 rounded-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10">
            <p className="text-[10px] text-[#888888] uppercase tracking-wider">© {new Date().getFullYear()} SecuriTrust Foundation. All rights reserved.</p>
