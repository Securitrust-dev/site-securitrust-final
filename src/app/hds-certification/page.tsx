          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                { title: 'GRC Cybersécurité', href: '/grc-cyber', desc: 'Gouvernance, gestion des risques et conformité pour structurer votre programme sécurité santé.' },
                { title: 'RSSI Externalisé', href: '/rssi-externalise', desc: 'Pilotez votre conformité HDS et votre stratégie sécurité avec un RSSI expert du secteur santé.' },
              ].map((s, i) => (
