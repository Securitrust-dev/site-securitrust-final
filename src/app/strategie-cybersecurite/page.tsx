...
import { Target, CheckCircle, TrendingUp, Shield, Brain, ArrowRight, Box, Cpu } from 'lucide-react';

export default function StrategieCybersecuritePage() {
  return (
          ...
          <div className="max-w-7xl mx-auto">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-slate-400 font-light tracking-wide border-l-2 border-cyan-500 pl-6 text-left mb-6">
                La <strong>stratégie cybersécurité</strong> définit la <strong>vision</strong>, les <strong>objectifs</strong> et la <strong>feuille de route</strong> pour protéger durablement votre organisation face aux menaces numériques.
              </p>
              <p className="text-lg md:text-xl text-slate-400 font-light tracking-wide border-l-2 border-cyan-500 pl-6 text-left">
                Elle permet d&apos;aligner les <strong>investissements sécurité</strong> avec les <strong>priorités business</strong>, d&apos;optimiser les ressources et de construire une <strong>posture de sécurité cohérente</strong> et évolutive.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 relative z-10">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-end justify-between mb-16 border-b border-white/10 pb-4">
              ...
              <span className="text-cyan-500 font-mono text-xs">01 // COMPOSANTES</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden border-cyan-500/30 shadow-[0_0_15px_rgba(118,166,209,0.1)]">
                  ...
                  <h4 className="text-xl font-medium text-white mb-4">Vision et objectifs</h4>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Définir la vision cyber à 3-5 ans et les objectifs stratégiques alignés avec le business
                  </p>
                </div>
              </div>
              ...
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden">
                  ...
                  <h4 className="text-xl font-medium text-white mb-4">Analyse de risques</h4>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Cartographier les menaces, vulnérabilités et impacts potentiels sur l&apos;organisation
                  </p>
                </div>
              </div>
              ...
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden">
                  ...
                  <h4 className="text-xl font-medium text-white mb-4">Feuille de route</h4>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Plan d&apos;action pluriannuel avec priorités, budgets et jalons de mise en œuvre
                  </p>
                </div>
              </div>
              ...
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden">
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Structure organisationnelle, rôles, responsabilités et processus de pilotage
                  </p>
                </div>
              </div>
              ...
              <div className="tilt-card group relative z-10 p-1">
                <div className="glass-panel h-full p-8 rounded-xl relative overflow-hidden">
                  ...
                  <h4 className="text-xl font-medium text-white mb-4">Indicateurs de performance</h4>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    KPI et métriques pour mesurer l&apos;efficacité et le niveau de maturité cyber
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="glass-panel p-8 rounded-xl border border-white/5">
                <h3 className="text-2xl font-bold text-cyan-400 mb-6">Approche structurée</h3>
                <ul className="space-y-4 text-slate-300">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Diagnostic de l&apos;existant et cartographie des actifs</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Analyse de risques et évaluation de maturité</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Définition de la vision et des objectifs cyber</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Construction de la roadmap avec priorisation</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Présentation au COMEX et plan de communication</span>
                  </li>
                </ul>
              </div>

              <div className="glass-panel p-8 rounded-xl border border-white/5">
                <h3 className="text-2xl font-bold text-cyan-400 mb-6">Bénéfices clés</h3>
                <ul className="space-y-4 text-slate-300">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Vision claire et partagée de la cybersécurité</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Alignement cyber / business et support de la direction</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Réduction des risques et amélioration de la résilience</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                    <span>Conformité réglementaire et avantage concurrentiel</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="glass-panel p-12 rounded-2xl border-2 border-cyan-500/20 relative overflow-hidden">
              ...
              <h2 className="text-4xl md:text-5xl font-semibold text-white mb-6 tracking-tight relative z-10">
                Définissez votre stratégie cyber
              </h2>
              <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto relative z-10">
                Construisez une feuille de route cybersécurité alignée avec vos objectifs business et vos contraintes.
              </p>
        ...
        <section className="py-16 px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { title: 'RSSI Externalisé', href: '/rssi-externalise', desc: 'Exécutez votre stratégie cybersécurité avec un RSSI expert à temps partagé, sans contraintes RH.' },
                { title: 'Gestion des Risques', href: '/gestion-risques', desc: 'Identifiez et priorisez vos risques cyber pour orienter votre stratégie sécurité efficacement.' },
                { title: 'Audit Cybersécurité', href: '/audit-cybersecurite', desc: 'Évaluez votre posture de sécurité et obtenez un plan d\'action stratégique priorisé.' },
              ].map((s, i) => (
