...
export const OrangeBeamCTA = ({ href, text, icon, onClick, isVisible = true, external }: OrangeBeamCTAProps) => {
  if (!isVisible) return null;

  if (external) {
    return (
      <a href={href} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto" onClick={onClick}>
