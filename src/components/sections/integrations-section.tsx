      ...
      <div className="max-w-[1400px] mx-auto space-y-12 sm:space-y-16 lg:space-y-20">
        {/* Header */}
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-white text-base sm:text-lg lg:text-xl max-w-3xl mx-auto px-4">
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm sm:text-base text-white text-center opacity-0 group-hover:opacity-100 transition-opacity leading-tight">
                    {service.description}
                  </p>
                </Link>
              );
