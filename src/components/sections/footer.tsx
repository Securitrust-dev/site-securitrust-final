        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-12 mb-12 sm:mb-16 lg:mb-20">
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-white opacity-80">
                <li>
                  <a href="/rssi-externalise" className="hover:text-cyan-400 transition-colors font-light">
                    RSSI Externalisé
                  </a>
                </li>
                <li>
                  <a href="/audit-cybersecurite" className="hover:text-cyan-400 transition-colors font-light">
                    Audits & Pentests
                  </a>
                </li>
                <li>
                  <a href="/mise-en-conformite-rgpd" className="hover:text-cyan-400 transition-colors font-light">
                    Conformité RGPD
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-white opacity-80">
                ...
                <li>
                  <a href="/dora" className="hover:text-cyan-400 transition-colors font-light">
                    DORA
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-white opacity-80">
                <li>
                  <a href="/proposition-commerciale" className="hover:text-cyan-400 transition-colors font-light">
                    Devis
                  </a>
                </li>
                <li>
                  <a href="/contact" className="hover:text-cyan-400 transition-colors font-light">
                    Support
                  </a>
                </li>
                <li>
                  <a href="/cgv" className="hover:text-cyan-400 transition-colors font-light">
                    CGV
                  </a>
                </li>
                <li>
                  <a href="/mentions-legales" className="hover:text-cyan-400 transition-colors font-light">
                    Mentions légales
                  </a>
                </li>
                <li>
                  <a href="/politique-de-confidentialite" className="hover:text-cyan-400 transition-colors font-light">
                    Politique de confidentialité
                  </a>
                </li>
                <li>
                  <a href="/politique-de-cookies" className="hover:text-cyan-400 transition-colors font-light">
