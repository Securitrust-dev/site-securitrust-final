      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        <div className="mb-16 reveal">
          <h2 className="font-display text-6xl md:text-8xl font-black tracking-tighter uppercase text-white leading-[0.8]">
            Compréhension<br />
            <span className="text-[#9abff2]">du besoin</span>
          </h2>
        ...
        <div className="mb-12 p-8 bg-[#080808] border border-white/10 rounded-3xl reveal">
          <div className="flex items-center justify-between mb-8">
            ...
            <button 
              ...
              className={`px-4 py-1 rounded-full text-[10px] uppercase font-bold transition-all ${isAutoMode ? 'bg-[#9abff2] text-black' : 'bg-white/10 text-white/40'}`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white focus:border-[#9abff2] outline-none transition-all"
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="mt-6 space-y-2">
            ...
            <textarea 
              ...
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white focus:border-[#9abff2] outline-none transition-all h-20 resize-none"
            />
          </div>
        </div>
