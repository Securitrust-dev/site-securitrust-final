      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        <div className="mb-16 reveal">
          <h2 className="font-display text-6xl md:text-8xl font-black tracking-tighter uppercase text-white leading-[0.8]">
            Compréhension<br />
            <span className="text-[#74a2cd]">du besoin</span>
          </h2>
          <p className="mt-6 text-xl text-white/40 font-light tracking-wide">
        ...
        <div className="mb-12 p-8 bg-[#121212] border border-white/10 rounded-3xl reveal">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-[#74a2cd] font-bold uppercase tracking-widest text-sm">Configuration du client</h3>
            <button 
              onClick={() => setIsAutoMode(!isAutoMode)}
              className={`px-4 py-1 rounded-full text-[10px] uppercase font-bold transition-all ${isAutoMode ? 'bg-[#74a2cd] text-black' : 'bg-white/10 text-white/40'}`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white focus:border-[#74a2cd] outline-none transition-all"
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="mt-6 space-y-2">
            ...
            <textarea 
              ...
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white focus:border-[#74a2cd] outline-none transition-all h-20 resize-none"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 reveal">
          {/* Contexte Box */}
          <div className="group">
            <div className="inline-block bg-[#74a2cd] text-[#0a0a0a] px-8 py-2 rounded-full font-bold text-sm uppercase tracking-widest mb-6 shadow-[0_0_20px_rgba(154,191,242,0.3)]">
              Contexte
            </div>
            <div className="bg-[#121212] border border-white/10 rounded-3xl p-8 md:p-10 hover:border-[#74a2cd]/30 transition-all duration-500 shadow-2xl relative">
              {!isAutoMode && (
                <div className="absolute top-4 right-4 text-[10px] text-[#74a2cd] uppercase font-bold tracking-widest bg-[#74a2cd]/10 px-2 py-1 rounded">
                  Édition Manuelle
                </div>
              )}
                <textarea
                  ...
                  className="w-full bg-transparent text-white/90 text-lg leading-relaxed border-none focus:ring-0 resize-none overflow-hidden min-h-[300px]"
          ...
          <div className="group">
            <div className="inline-block bg-[#74a2cd] text-[#0a0a0a] px-8 py-2 rounded-full font-bold text-sm uppercase tracking-widest mb-6 shadow-[0_0_20px_rgba(154,191,242,0.3)]">
              ...
              <div className="bg-[#121212] border border-white/10 rounded-3xl p-8 md:p-10 hover:border-[#74a2cd]/30 transition-all duration-500 shadow-2xl">
                <textarea
                  ref={objectivesRef}
                  value={objectives}
                  onChange={(e) => setObjectives(e.target.value)}
                  className="w-full bg-transparent text-white/90 text-lg leading-relaxed border-none focus:ring-0 resize-none overflow-hidden min-h-[250px]"
