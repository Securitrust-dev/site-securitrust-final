      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        <div className="mb-20 reveal">
          <h2 className="font-display text-5xl md:text-7xl font-black tracking-tighter uppercase text-white leading-none mb-4">
            Méthodologie - <span className="text-[#00ffa3]">Phase d&apos;audit</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="reveal">
            <h3 className="text-lg font-mono text-[#00ffa3] uppercase tracking-[0.2em] mb-8">
            ...
            <div className="space-y-6">
              {standards.map((std, idx) => (
                <div key={idx} className="flex gap-4 group">
                  <span className="text-[#00ffa3] font-bold shrink-0 pt-1">➤</span>
                  <p className="text-white/90 leading-relaxed group-hover:text-white transition-colors">
                    <span className="font-bold text-[#00ffa3]">{std.name}</span> — {std.desc}
                  </p>
                </div>
              ))}
            </div>
          ...
          <div className="reveal bg-[#080808] border border-white/10 rounded-3xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 gap-12 relative">
               ...
               <div className="flex flex-col md:flex-row gap-6 mb-8">
                  <div className="flex-1 bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-center items-center text-center group hover:border-[#00ffa3]/40 transition-all">
                     <div className="w-12 h-12 rounded-full border border-[#00ffa3]/30 flex items-center justify-center mb-4 font-bold text-[#00ffa3]">1</div>
                     <h4 className="text-white font-bold uppercase tracking-tighter">Tests d&apos;intrusion externe</h4>
                     <p className="text-[#00ffa3] text-xs font-mono mt-2">✓ Boîte noire</p>
                  </div>
                  <div className="flex-1 bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-center items-center text-center group hover:border-[#00ffa3]/40 transition-all">
                     <div className="w-12 h-12 rounded-full border border-[#00ffa3]/30 flex items-center justify-center mb-4 font-bold text-[#00ffa3]">2</div>
