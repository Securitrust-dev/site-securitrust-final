...
export function PropositionIntroduction() {
  return (
    <section id="presentation" className="py-24 bg-[#0a0a0a] relative overflow-hidden border-t border-border">
      {/* Background decoration */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-20">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-[#74a2cd]/5 blur-[150px] rounded-full"></div>
      </div>

      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        <div className="mb-16 reveal">
          <h2 className="font-sans text-4xl md:text-5xl font-bold tracking-wide uppercase text-white leading-tight">
              Présentation de<br />
              <span className="text-[#74a2cd]">SecuriTrust</span>
            </h2>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 reveal">
          {/* Main Info Box */}
          <div className="lg:col-span-8 flex flex-col bg-[#121212] border border-white/10 rounded-3xl overflow-hidden group hover:border-[#74a2cd]/40 transition-all duration-500 p-8 md:p-12">
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            {/* Label Promo Box */}
            <div className="flex-1 bg-[#121212] border border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center text-center group hover:border-[#74a2cd]/40 transition-all duration-500">
