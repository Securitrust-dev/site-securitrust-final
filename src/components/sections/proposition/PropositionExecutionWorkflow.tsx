      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        <div className="mb-20 reveal">
          <h2 className="font-display text-4xl md:text-6xl font-black tracking-tighter uppercase text-white leading-none mb-4 text-center">
            Workflow <span className="text-[#00ffa3]">d&apos;exécution</span>
          </h2>
        </div>
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-4 py-12">
          ...
          <div className="reveal w-full max-w-sm lg:w-[22%] group">
            <div className="bg-[#080808] border border-white/5 rounded-2xl p-6 relative overflow-hidden transition-all duration-500 hover:border-[#00ffa3]/30 hover:bg-[#0a0a0a]">
          ...
          <div className="reveal w-full max-w-sm lg:w-[26%] group">
            <div className="bg-[#080808] border border-white/5 rounded-2xl p-6 relative overflow-hidden transition-all duration-500 hover:border-[#00ffa3]/30 hover:bg-[#0a0a0a]">
              ...
              <div className="flex gap-3">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="w-8 h-8 rounded-lg bg-[#00ffa3]/5 border border-[#00ffa3]/10 flex items-center justify-center text-[#00ffa3]/40">
            ...
            <div className="bg-[#080808] border border-white/5 rounded-2xl p-6 relative overflow-hidden transition-all duration-500 hover:border-[#00ffa3]/30 hover:bg-[#0a0a0a]">
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg px-4 py-2 mb-6">
                <p className="text-[11px] font-mono text-white/60">
                  Audit technique - <span className="text-[#00ffa3]">45 vulnérabilités identifiées</span>
                </p>
              </div>
        ...
        <div className="mt-20 flex flex-wrap justify-center gap-4 reveal">
          ...
          <div className="flex items-center gap-4 px-6 py-3 bg-[#00ffa3] rounded-lg">
